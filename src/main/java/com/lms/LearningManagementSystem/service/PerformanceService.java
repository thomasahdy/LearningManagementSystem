...
public class PerformanceService {
    ...
    @Autowired
    public PerformanceService(PerformanceRepository performanceRepository, EnrollmentRepository enrollmentRepository) {
    ...
    public Performance updatePerformance(Long enrollmentId, Double quizScore, Double assignmentScore, boolean attendanceMarked) {
        ...
        performance.setAssignmentGrade(assignmentScore);
